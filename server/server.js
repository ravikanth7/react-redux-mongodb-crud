...
const accessLogStream = fs.createWriteStream(__dirname + '/../log/' + environment+'.log', {flags: 'a'});
  ...
  return `
    ...
    <html>
      <head>
        ...
        <style type="text/css">
          @import url('/fontawesome/font-awesome-css.min.css');
          @font-face {
            font-family: 'FontAwesome';
            src: url('/fontawesome/fontawesome-webfont.eot');
            src: url('/fontawesome/fontawesome-webfont.eot?#iefix') format('embedded-opentype'), url('/fontawesome/fontawesome-webfont.woff') format('woff'), url('/fontawesome/fontawesome-webfont.ttf') format('truetype'), url('/fontawesome-webfont.svg#fontawesomeregular') format('svg');
            font-weight: normal;
            font-style: normal;
          }
        </style>
